...
class TestGlobSearch:
    ...
    @pytest.mark.asyncio
    async def test_glob_find_all_markdown(self, sample_book_data):
...
class TestGrepSearch:
    ...
    @pytest.mark.asyncio
    async def test_grep_find_keyword(self, sample_book_data):
    ...
    @pytest.mark.asyncio
    async def test_grep_regex_pattern(self, sample_book_data):
    ...
    @pytest.mark.asyncio
    async def test_grep_no_matches(self, sample_book_data):
    ...
    @pytest.mark.asyncio
    async def test_grep_max_results_limit(self, sample_book_data):
    ...
    @pytest.mark.asyncio
    async def test_grep_invalid_regex(self, sample_book_data):
