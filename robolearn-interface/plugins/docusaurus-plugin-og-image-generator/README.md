...
- **Beautiful Template**: Professional gradient design with branding
...
```
┌────────────────────────────────────────────────────────────┐
│  Site Brand • Tagline                          [gradient bg] │
│                                                             │
│                                                             │
│     Chapter Title Here                                     │
...
docs/module-1/getting-started.md → module-1-getting-started.png
```
