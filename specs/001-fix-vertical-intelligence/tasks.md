...
- [ ] T001 Add header section explaining "Current Reality" vs "Future State" distinction in `.specify/memory/constitution.md`
- [ ] T002 Update Current Reality section: document 14 chapters across Parts 1/2/3/5 (not 55 chapters)
- [ ] T003 Update Current Reality section: document semantic skills activation model (current implementation)
- [ ] T004 Move aspirational content (55 chapters, 13 parts, plugin architecture) to clearly-marked Future State section
- [ ] T005 Update terminology throughout constitution: "sections" (not "lessons"), "readme.md" (not "README.md")
- [ ] T006 Document two-level chapter structure explicitly: Chapter level (readme.md overview) vs Section level (01-name.md content)
- [ ] T007 Update book statistics: clarify 14 chapters exist, 41 planned for future
- [ ] T008 Add cross-references linking Current Reality sections to corresponding Future State sections
- [ ] T009 Run AI validation scan comparing old vs new constitution terminology, generate evidence report in `specs/001-fix-vertical-intelligence/validation/layer-constitution-validation.md`
...
- [ ] T011 Rewrite `.claude/output-styles/chapters.md`: correct structure to Part (Title-Case) → Chapter (lowercase) → readme.md (lowercase)
- [ ] T012 Add actual example from Chapter 1 to chapters.md: readme.md + 8 section files with descriptive names (01-moment_that_changed_everything.md style)
- [ ] T013 Update all terminology in chapters.md: "sections" (not "lessons"), "13 parts aspirational" (not "7 parts")
- [ ] T014 Update `.claude/output-styles/lesson.md`: include actual YAML frontmatter example from book-source/docs/part-1/01-chapter-1-foundations/01-moment_that_changed_everything.md
- [ ] T015 Document two-level structure in lesson.md: Chapter README (overview + "What You'll Learn") vs Section files (YAML + content + "Try With AI")
- [ ] T016 Add metadata comment requirements example to lesson.md showing format: Generated by, Source spec, Created date, Git author, Workflow
- [ ] T017 Add policy note for lesson authors: Within chapter, each lesson must end with single "Try With AI" section (no "Key Takeaways" or "What's Next")
- [ ] T018 Run AI validation comparing output styles against actual Chapter 1 structure, report discrepancies in `specs/001-fix-vertical-intelligence/validation/layer-output-styles-validation.md`
- [ ] T019 Human review: Domain expert spot-checks 3 sample files and approves template corrections

#### Day 5: PROJECT-STRUCTURE-REALITY.md Creation (FR-013 to FR-015)

- [ ] T020 Create `.claude/PROJECT-STRUCTURE-REALITY.md` as single source of truth
- [ ] T021 Add section 1: Actual directory tree from book-source/docs/ showing Parts 1/2/3/5 structure
- [ ] T022 Add section 2: Terminology definitions (Part → Chapter → Section, not "lessons"; readme.md lowercase)
- [ ] T023 Add section 3: Canonical example showing Chapter 1 structure (readme.md + 8 descriptive section files)
- [ ] T024 Add section 4: Two-level architecture explanation (Chapter README overview vs Section detailed content)
- [ ] T025 Add section 5: Link to constitution sections describing Future State (55 chapters, 13 parts)
- [ ] T026 Add section 6: Migration status tracker showing which parts implemented (1/2/3/5) vs planned (4/6-13)
- [ ] T027 Run AI validation verifying all examples in PROJECT-STRUCTURE-REALITY.md match actual file structure
- [ ] T028 Human review: Domain expert confirms canonical example represents best practice
...
- [ ] T030 Add reference to PROJECT-STRUCTURE-REALITY.md in chapter-planner.md for structure/terminology ground truth
- [ ] T031 Update chapter-planner.md output specification: chapter readme.md (overview + "What You'll Learn") + section plans (title, YAML metadata, content outline, "Try With AI")
- [ ] T032 Update all terminology in chapter-planner.md: "sections" (not "lessons"), reference descriptive names
- [ ] T033 Add instruction to chapter-planner.md: map skills with CEFR proficiency levels per skills-proficiency-mapper
- [ ] T034 Update `.claude/agents/lesson-writer.md`: add prominent note that despite filename, it generates "sections" not "lessons"
- [ ] T035 Add reference to PROJECT-STRUCTURE-REALITY.md in lesson-writer.md for examples and structure
...
- [ ] T037 Clarify two-level output in lesson-writer.md: chapter readme.md (lowercase) vs numbered section files (01-descriptive-name.md)
- [ ] T038 Update `.claude/agents/technical-reviewer.md`: remove hardcoded skill count references
- [ ] T039 Add validation checks to technical-reviewer.md: terminology consistency, file naming (descriptive not generic), two-level chapter architecture
- [ ] T040 Add reference to PROJECT-STRUCTURE-REALITY.md in technical-reviewer.md as validation standard
