...
- [ ] T029 Update `.claude/agents/chapter-planner.md`: remove hardcoded skill counts ("8 skills", "9 skills")
- [ ] T030 Add reference to specs/book/chapter-index.md in chapter-planner.md for current chapter status
- [ ] T031 Update chapter-planner.md output specification: reference output-styles templates for structure
- [ ] T032 Verify terminology in chapter-planner.md matches actual usage (keep "lessons" terminology)
- [ ] T033 Add instruction to chapter-planner.md: map skills with CEFR proficiency levels per skills-proficiency-mapper
- [ ] T034 Update `.claude/agents/lesson-writer.md`: reference output-styles for structure examples
- [ ] T035 Add reference to specs/book/chapter-index.md and book-source/docs/ for structure examples
- [ ] T036 Update lesson-writer.md to generate metadata comments showing: Generated by (subagent + version), Source spec (path), Created (date), Git author, Workflow (command)
- [ ] T037 Clarify two-level output in lesson-writer.md: reference output-styles/chapters.md and lesson.md for structure
- [ ] T038 Update `.claude/agents/technical-reviewer.md`: remove hardcoded skill count references
- [ ] T039 Add validation checks to technical-reviewer.md: verify against output-styles templates and chapter-index.md
- [ ] T040 Add reference to specs/book/chapter-index.md in technical-reviewer.md as current status reference
- [ ] T041 Run AI scan of each subagent file, flag remaining contradictions in `specs/001-fix-vertical-intelligence/validation/layer-subagents-validation.md`
- [ ] T042 Human review: Domain expert reviews subagent alignment and approves changes
