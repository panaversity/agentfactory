...
- **Input**: book-source/docs/chapter-index.md
...
- **Owner**: Implementation agent
- **Input**: book-source/docs/03-Markdown-Prompt-Context-Engineering/11-context-engineering-for-ai-driven-development/README.md
...
- **Owner**: Implementation agent
- **Action**: Verify book-source/docs/03-Markdown-Prompt-Context-Engineering/11-context-engineering-for-ai-driven-development/ exists
...
- **Owner**: content-implementer
- **Output**: book-source/docs/03-Markdown-Prompt-Context-Engineering/11-context-engineering-for-ai-driven-development/01-context-windows-token-counting.md
...
- **Output**: book-source/docs/03-Markdown-Prompt-Context-Engineering/11-context-engineering-for-ai-driven-development/README.md
- **Status**: ⬜ Pending
