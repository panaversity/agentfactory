...
- [ ] T007 [US5] Rename Part 4 (Python) to Part 5: `git mv book-source/docs/04-Python-Fundamentals book-source/docs/05-Python-Fundamentals`
- [ ] T008 [US5] Rename Part 5 (SDD) to Part 4: `git mv book-source/docs/05-Spec-Driven-Development book-source/docs/04-SDD-RI-Fundamentals`
- [ ] T009 [US5] Create Part 6 directory: `mkdir -p book-source/docs/06-AI-Product-Leadership`
- [ ] T010 [US5] Verify part directory structure: `ls -1d book-source/docs/0*` (should show 01-06 parts)
...
- [ ] T055 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/30-python-package-managers-comparison book-source/docs/05-Python-Fundamentals/33-python-package-managers-comparison`
- [ ] T056 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/29-async-and-concurrency book-source/docs/05-Python-Fundamentals/32-async-and-concurrency`
- [ ] T057 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/28-python-docstrings-for-genai book-source/docs/05-Python-Fundamentals/31-python-docstrings-for-genai`
- [ ] T058 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/27-reading-and-writing-files book-source/docs/05-Python-Fundamentals/30-reading-and-writing-files`
- [ ] T059 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/26-error-handling-and-exceptions book-source/docs/05-Python-Fundamentals/29-error-handling-and-exceptions`
- [ ] T060 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/25-modules-packages-imports book-source/docs/05-Python-Fundamentals/28-modules-packages-imports`
- [ ] T061 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/24-dictionaries book-source/docs/05-Python-Fundamentals/27-dictionaries`
- [ ] T062 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/23-lists-and-tuples book-source/docs/05-Python-Fundamentals/26-lists-and-tuples`
- [ ] T063 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/22-loops book-source/docs/05-Python-Fundamentals/25-loops`
- [ ] T064 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/21-conditionals book-source/docs/05-Python-Fundamentals/24-conditionals`
- [ ] T065 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/20-functions book-source/docs/05-Python-Fundamentals/23-functions`
- [ ] T066 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/19-operators-and-expressions book-source/docs/05-Python-Fundamentals/22-operators-and-expressions`
- [ ] T067 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/18-variables-data-types book-source/docs/05-Python-Fundamentals/21-variables-data-types`
- [ ] T068 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/17-control-flow-overview book-source/docs/05-Python-Fundamentals/20-control-flow-overview`
- [ ] T069 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/16-python-syntax-basics book-source/docs/05-Python-Fundamentals/19-python-syntax-basics`
- [ ] T070 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/15-interactive-python-in-claude-ai book-source/docs/05-Python-Fundamentals/18-interactive-python-in-claude-ai`
- [ ] T071 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/14-introduction-to-python book-source/docs/05-Python-Fundamentals/17-introduction-to-python`
- [ ] T072 [US2] Move chapter: `git mv book-source/docs/05-Python-Fundamentals/13-python-uv-package-manager book-source/docs/05-Python-Fundamentals/16-python-uv-package-manager`

### SDD Chapters (31-32 → 13-14)

- [ ] T073 [US2] Move chapter: `git mv book-source/docs/04-SDD-RI-Fundamentals/32-spec-kit-plus-hands-on book-source/docs/04-SDD-RI-Fundamentals/14-youtube-content-workflow-gemini`
- [ ] T074 [US2] Move chapter: `git mv book-source/docs/04-SDD-RI-Fundamentals/31-specification-driven-development-fundamentals book-source/docs/04-SDD-RI-Fundamentals/13-specification-driven-development-fundamentals`

### AI Orchestra Chapter (33 → 35)

- [ ] T075 [US2] Move chapter: `git mv book-source/docs/04-SDD-RI-Fundamentals/33-ai-orchestra-agent-teams-manager book-source/docs/06-AI-Product-Leadership/35-ai-orchestra-agent-teams-manager`
...
- [ ] T077 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/16-python-uv-package-manager/README.md (sidebar_position: 16, slides.source: /slides/chapter-16-slides.pdf)
- [ ] T078 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/17-introduction-to-python/README.md (sidebar_position: 17, slides.source: /slides/chapter-17-slides.pdf)
- [ ] T079 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/18-interactive-python-in-claude-ai/README.md (sidebar_position: 18, slides.source: /slides/chapter-18-slides.pdf)
- [ ] T080 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/19-python-syntax-basics/README.md (sidebar_position: 19, slides.source: /slides/chapter-19-slides.pdf)
- [ ] T081 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/20-control-flow-overview/README.md (sidebar_position: 20, slides.source: /slides/chapter-20-slides.pdf)
- [ ] T082 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/21-variables-data-types/README.md (sidebar_position: 21, slides.source: /slides/chapter-21-slides.pdf)
- [ ] T083 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/22-operators-and-expressions/README.md (sidebar_position: 22, slides.source: /slides/chapter-22-slides.pdf)
- [ ] T084 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/23-functions/README.md (sidebar_position: 23, slides.source: /slides/chapter-23-slides.pdf)
- [ ] T085 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/24-conditionals/README.md (sidebar_position: 24, slides.source: /slides/chapter-24-slides.pdf)
- [ ] T086 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/25-loops/README.md (sidebar_position: 25, slides.source: /slides/chapter-25-slides.pdf)
- [ ] T087 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/26-lists-and-tuples/README.md (sidebar_position: 26, slides.source: /slides/chapter-26-slides.pdf)
- [ ] T088 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/27-dictionaries/README.md (sidebar_position: 27, slides.source: /slides/chapter-27-slides.pdf)
- [ ] T089 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/28-modules-packages-imports/README.md (sidebar_position: 28, slides.source: /slides/chapter-28-slides.pdf)
- [ ] T090 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/29-error-handling-and-exceptions/README.md (sidebar_position: 29, slides.source: /slides/chapter-29-slides.pdf)
- [ ] T091 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/30-reading-and-writing-files/README.md (sidebar_position: 30, slides.source: /slides/chapter-30-slides.pdf)
- [ ] T092 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/31-python-docstrings-for-genai/README.md (sidebar_position: 31, slides.source: /slides/chapter-31-slides.pdf)
- [ ] T093 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/32-async-and-concurrency/README.md (sidebar_position: 32, slides.source: /slides/chapter-32-slides.pdf)
- [ ] T094 [P] [US1] Update YAML in book-source/docs/05-Python-Fundamentals/33-python-package-managers-comparison/README.md (sidebar_position: 33, slides.source: /slides/chapter-33-slides.pdf)

#### SDD Chapters (13-14) - YAML Updates

- [ ] T095 [P] [US1] Update YAML in book-source/docs/04-SDD-RI-Fundamentals/13-specification-driven-development-fundamentals/README.md (sidebar_position: 13, slides.source: /slides/chapter-13-slides.pdf)
- [ ] T096 [P] [US1] Update YAML in book-source/docs/04-SDD-RI-Fundamentals/14-youtube-content-workflow-gemini/README.md (sidebar_position: 14, slides.source: /slides/chapter-14-slides.pdf)

#### AI Orchestra Chapter (35) - YAML Update

- [ ] T097 [P] [US1] Update YAML in book-source/docs/06-AI-Product-Leadership/35-ai-orchestra-agent-teams-manager/README.md (sidebar_position: 35, slides.source: /slides/chapter-35-slides.pdf)
...
- [ ] T099 [P] [US3] Create Chapter 15 directory: `mkdir -p book-source/docs/04-SDD-RI-Fundamentals/15-ai-product-business-intelligence-capstone`
- [ ] T100 [P] [US3] Create Chapter 15 placeholder README.md at book-source/docs/04-SDD-RI-Fundamentals/15-ai-product-business-intelligence-capstone/README.md (YAML: sidebar_position: 15, title, slides metadata; content: chapter overview)
- [ ] T101 [P] [US3] Create Chapter 34 directory: `mkdir -p book-source/docs/06-AI-Product-Leadership/34-ai-product-development-evaluation-first`
- [ ] T102 [P] [US3] Create Chapter 34 placeholder README.md at book-source/docs/06-AI-Product-Leadership/34-ai-product-development-evaluation-first/README.md (YAML: sidebar_position: 34, title, slides metadata; content: chapter overview)
- [ ] T103 [P] [US3] Create Chapter 36 directory: `mkdir -p book-source/docs/06-AI-Product-Leadership/36-product-engineering-leadership-ai`
- [ ] T104 [P] [US3] Create Chapter 36 placeholder README.md at book-source/docs/06-AI-Product-Leadership/36-product-engineering-leadership-ai/README.md (YAML: sidebar_position: 36, title, slides metadata; content: chapter overview)
...
- [ ] T105 [US4] Update image markdown references in Python lesson files (grep `/img/part-4/chapter-` and replace with `/img/part-5/chapter-` using +3 shift): `find book-source/docs/05-Python-Fundamentals -name "*.md" -type f` (automated search-and-replace)
- [ ] T106 [US4] Update image markdown references in SDD lesson files (grep `/img/part-5/chapter-31` → `/img/part-4/chapter-13`, etc.): `find book-source/docs/04-SDD-RI-Fundamentals -name "*.md" -type f`
- [ ] T107 [US4] Update image markdown references in AI Orchestra lesson files (grep `/img/part-5/chapter-33` → `/img/part-6/chapter-35`): `find book-source/docs/06-AI-Product-Leadership -name "*.md" -type f`
...
- [ ] T112 [US1] Update "Chapter 33" → "Chapter 35" in all lesson content: `grep -rl "Chapter 33" book-source/docs/` (automated replace, affects AI Orchestra mentions)
- [ ] T113 [US1] Update "Chapter 32" → "Chapter 14" in all lesson content: `grep -rl "Chapter 32" book-source/docs/` (automated replace)
- [ ] T114 [US1] Update "Chapter 31" → "Chapter 13" in all lesson content: `grep -rl "Chapter 31" book-source/docs/` (automated replace)
- [ ] T115 [US1] Update "Chapter 30" → "Chapter 33" in all lesson content: `grep -rl "Chapter 30" book-source/docs/` (automated replace, Python chapters start here)
- [ ] T116 [US1] Update "Chapter 29" → "Chapter 32" in all lesson content: `grep -rl "Chapter 29" book-source/docs/`
- [ ] T117 [US1] Update "Chapter 28" → "Chapter 31" in all lesson content: `grep -rl "Chapter 28" book-source/docs/`
- [ ] T118 [US1] Update "Chapter 27" → "Chapter 30" in all lesson content: `grep -rl "Chapter 27" book-source/docs/`
- [ ] T119 [US1] Update "Chapter 26" → "Chapter 29" in all lesson content: `grep -rl "Chapter 26" book-source/docs/`
- [ ] T120 [US1] Update "Chapter 25" → "Chapter 28" in all lesson content: `grep -rl "Chapter 25" book-source/docs/`
- [ ] T121 [US1] Update "Chapter 24" → "Chapter 27" in all lesson content: `grep -rl "Chapter 24" book-source/docs/`
- [ ] T122 [US1] Update "Chapter 23" → "Chapter 26" in all lesson content: `grep -rl "Chapter 23" book-source/docs/`
- [ ] T123 [US1] Update "Chapter 22" → "Chapter 25" in all lesson content: `grep -rl "Chapter 22" book-source/docs/`
- [ ] T124 [US1] Update "Chapter 21" → "Chapter 24" in all lesson content: `grep -rl "Chapter 21" book-source/docs/`
- [ ] T125 [US1] Update "Chapter 20" → "Chapter 23" in all lesson content: `grep -rl "Chapter 20" book-source/docs/`
- [ ] T126 [US1] Update "Chapter 19" → "Chapter 22" in all lesson content: `grep -rl "Chapter 19" book-source/docs/`
- [ ] T127 [US1] Update "Chapter 18" → "Chapter 21" in all lesson content: `grep -rl "Chapter 18" book-source/docs/`
- [ ] T128 [US1] Update "Chapter 17" → "Chapter 20" in all lesson content: `grep -rl "Chapter 17" book-source/docs/`
- [ ] T129 [US1] Update "Chapter 16" → "Chapter 19" in all lesson content: `grep -rl "Chapter 16" book-source/docs/`
- [ ] T130 [US1] Update "Chapter 15" → "Chapter 18" in all lesson content: `grep -rl "Chapter 15" book-source/docs/`
- [ ] T131 [US1] Update "Chapter 14" → "Chapter 17" in all lesson content: `grep -rl "Chapter 14" book-source/docs/`
- [ ] T132 [US1] Update "Chapter 13" → "Chapter 16" in all lesson content: `grep -rl "Chapter 13" book-source/docs/`
...
- [ ] T133 [US2] SC-001: Verify all 3 chapters moved with git history: `git log --follow --oneline book-source/docs/04-SDD-RI-Fundamentals/13-specification-driven-development-fundamentals | head -5` (expect commit history), repeat for chapters 14, 35
- [ ] T134 [US3] SC-002: Verify all 3 placeholder READMEs exist with valid YAML: `grep "sidebar_position:" book-source/docs/04-SDD-RI-Fundamentals/15-*/README.md book-source/docs/06-AI-Product-Leadership/34-*/README.md book-source/docs/06-AI-Product-Leadership/36-*/README.md`
...
- [ ] T136 [US5] SC-004: Verify directory structure (Part 4: 3 chapters, Part 5: 18, Part 6: 3): `ls -1d book-source/docs/04-SDD-RI-Fundamentals/*/ | wc -l` (expect 3), `ls -1d book-source/docs/05-Python-Fundamentals/*/ | wc -l` (expect 18), `ls -1d book-source/docs/06-AI-Product-Leadership/*/ | wc -l` (expect 3)
...
- [ ] T139 [US1] SC-007: Verify all moved chapter READMEs have correct sidebar_position: `grep "sidebar_position:" book-source/docs/04-SDD-RI-Fundamentals/13-*/README.md` (expect 13), repeat for all 21 affected chapters
...
- [ ] T142 [US4] SC-010: Verify all YAML slides.source references updated: `grep "slides.source:" book-source/docs/04-SDD-RI-Fundamentals/13-*/README.md` (expect /slides/chapter-13-slides.pdf), spot-check 5 random chapters
- [ ] T143 [US4] SC-011: Verify all image markdown references updated (no old part- paths): `grep -r "/img/part-4/chapter-" book-source/docs/05-Python-Fundamentals` (expect zero matches EXCEPT chapters 13-15 which weren't renumbered), `grep -r "/img/part-5/chapter-31\|chapter-32\|chapter-33" book-source/docs` (expect zero matches)
...
- [ ] T146 [US1] SC-014: Spot-check narrative chapter references: `grep -n "Chapter 16" book-source/docs/05-Python-Fundamentals/17-*/README.md` (verify mentions of Python UV chapter use new number 16 not 13), repeat for 4 more random chapters
...
- [ ] T149 [US5] Verify no orphaned files in old locations: `ls book-source/docs/04-Python-Fundamentals 2>/dev/null` (expect "No such file or directory"), `ls book-source/docs/05-Spec-Driven-Development 2>/dev/null` (expect "No such file or directory")
