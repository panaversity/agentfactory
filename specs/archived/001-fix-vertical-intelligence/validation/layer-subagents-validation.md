...
2. **content-implementer.md** (T034-T037): 3 updates adding YAML metadata specification, chapter-index.md references, book-source validation
3. **validation-auditor.md** (T038-T040): 3 updates removing hardcoded skill counts, adding evals-first validation, chapter-index.md references
...
| Requirement | chapter-planner.md | content-implementer.md | validation-auditor.md | Status |
|-------------|-------------------|------------------|----------------------|--------|
...
| | validation-auditor.md | Lines 44, 501 |
...
| | content-implementer.md | Lines 163-179 |
...
| | validation-auditor.md | Line 90 |
| lesson.md structure | chapter-planner.md | Line 325 |
| | content-implementer.md | Lines 83, 183, 197 |
| | validation-auditor.md | Line 90 |
| YAML frontmatter (7 fields) | content-implementer.md | Lines 88, 97, 197-200 |
...
| AI tool onboarding sequence | content-implementer.md | Line 150 |
...
### content-implementer.md Changes
...
4. **Metadata Completeness**: Verify content-implementer.md correctly specifies all 7 generation metadata fields
...
$ wc -l .claude/agents/content-implementer.md
[count lines]

$ wc -l .claude/agents/validation-auditor.md
[count lines]
...
content-implementer.md:181:   - The project constitution (`.specify/memory/constitution.md`) for vision and principles
validation-auditor.md:44:3. **Constitution Alignment**: CoLearning Domain Skills (from `.claude/skills/` directory) applied contextually
...
content-implementer.md:150:  - How to decide: consult `specs/book/chapter-index.md` and the chapter plan
content-implementer.md:182:   - The chapter-index (from `specs/book/chapter-index.md`) for chapter-level context
validation-auditor.md:89:- **Validate chapter context**: Reference `specs/book/chapter-index.md` to verify chapter number
...
content-implementer.md:83:**Template**: Use `.claude/output-styles/lesson.md` as a structural guide
content-implementer.md:197:   - **Generate YAML frontmatter** with all required metadata (see `.claude/output-styles/lesson.md`
validation-auditor.md:90:- **Validate structure**: Compare against `.claude/output-styles/chapters.md` and `.claude/output-styles/lesson.md`
```
