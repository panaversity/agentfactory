...
1. **Enforce Closure Policy Universally**: Add validation step in content-implementer or chapter-writer to verify every lesson ends with "## Try With AI" (grep check before completion)
