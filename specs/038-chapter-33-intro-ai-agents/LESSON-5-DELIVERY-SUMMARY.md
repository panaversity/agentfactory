...
**Date**: 2025-11-27
**Status**: ✅ DELIVERED
**File**: `book-source/docs/06-AI-Native-Software-Development/33-introduction-to-ai-agents/05-agent-ops.md`
...
- **Location**: `/book-source/docs/06-AI-Native-Software-Development/33-introduction-to-ai-agents/05-agent-ops.md`
...
- ✅ SDD-RI mindset: "Define success metrics *before* building evaluation system"
...
### 1. Started with "Why"
Rather than immediately teaching LM-as-Judge, the lesson opens with "Why does traditional testing break?" This creates motivation and context. Students understand the *problem* Agent Ops solves before learning the solution.
...
1. **Lesson Content**:
   - `/book-source/docs/06-AI-Native-Software-Development/33-introduction-to-ai-agents/05-agent-ops.md`
