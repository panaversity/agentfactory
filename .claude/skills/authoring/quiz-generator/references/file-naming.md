...
- `07_chapter_05_quiz.md` → Chapter N quiz
- `06_chapter_14_quiz.md` → Chapter N quiz
...
```
robolearn-interface/docs/part-1-foundations/chapter-02-ai-turning-point/
  01_lesson_01.md
  02_lesson_02.md
  03_lesson_03.md
  04_lesson_04.md
...
**Chapter 2:**
```
robolearn-interface/docs/part-1-foundations/chapter-02-ai-turning-point/05_chapter_02_quiz.md
```

**Chapter N:**
```
robolearn-interface/docs/part-2-workflows/chapter-05-claude-features/07_chapter_05_quiz.md
```

**Chapter N:**
```
robolearn-interface/docs/part-3-advanced/chapter-N-debugging/06_chapter_14_quiz.md
```
...
- [ ] Path is: `robolearn-interface/docs/[part]/[chapter]/##_chapter_##_quiz.md`
