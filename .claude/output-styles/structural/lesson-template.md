...
description: Generic lesson format for educational content & Agentic AI (13-part structure aspirational, with agentic AI and MCP guidance). Includes hidden skills proficiency metadata (CEFR/Bloom's) in YAML frontmatter for institutional integration.
---
...
**Note**: Lessons are components within chapters. For context on which chapter and part you're writing for, consult **`specs/book/chapter-index.md`** for chapter assignments and **`robolearn-interface/docs/`** to understand the overall book structure and flow. This output style provides the TEMPLATE for lesson files; the chapter organization is defined separately.
...
- Location: `robolearn-interface/docs/NN-Part-Name/NN-chapter-name/readme.md`
- Structure:
...
- Location: `robolearn-interface/docs/NN-Part-Name/NN-chapter-name/NN-descriptive-lesson-name.md`
- Structure:
...
**CRITICAL**: Technical lessons MUST integrate **AI-Native CoLearning** structural elements throughout (not just "Try With AI" at end). Apply the Panaversity Teaching Layer patterns.
