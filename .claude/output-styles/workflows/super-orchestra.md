...
**Don't Say**: "I'll implement Chapter N now."
...
## Example: Chapter N Skills/Plugins/MCP Session

**See**: `specs/018-chapter-N-claude-code-rework/` for complete example
...
**Style Status**: v0.1 (Baby/Preview) - Successfully demonstrated in Chapter N session
