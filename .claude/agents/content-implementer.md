...
1. **Lesson content files**: Use exact path from tasks.md
   - Example: `apps/learn-app/docs/02-AI-Tool-Landscape/08-git-and-github/01-lesson-1.md`
   - Pattern: `apps/learn-app/docs/[part-folder]/[chapter-folder]/[lesson-file].md`
...
3. **Templates for students**: Save to templates directory
   - Example: `apps/learn-app/templates/git-workflow-template.md`
   - Pattern: `apps/learn-app/templates/[template-name].md`
