...
- Section IIa (4-Layer Method): Manual → AI-Assisted → Reusable Intelligence → Spec-Driven progression
...
**Pattern Recognition**: Chapter N now mirrors Chapter 1's pedagogical structure (clean "Try With AI" format, realistic durations, anti-over-engineering).
...
- Identifies strategic gap: "Missing Skills/Plugins/MCP in Chapter N"
...
3. **Constitution Cross-Reference**:
   ...
   - Apply Section IIa (4-Layer Teaching Method)
...
User: "Chapter N is missing Skills/Plugins/MCP. This is crucial for AIDD personalization."

# Invoke Super Orchestra
/invoke super-orchestra "Research Skills/Plugins/MCP from Context7 + official sources, then update Chapter N spec/plan/tasks to make it the most comprehensive Claude Code education available."
```
...
### This Session (Chapter N Skills/Plugins/MCP):
...
- **1x Engineer** (traditional): Would implement Chapter N with Skills mentioned briefly (2-3 days)
...
- `specs/018-chapter-N-claude-code-rework/spec.md` (50 FRs, 25 SCs, 9 Evals)
- `specs/018-chapter-N-claude-code-rework/plan.md` (Lesson 4 expanded)
- `specs/018-chapter-N-claude-code-rework/tasks.md` (Phase 6 expanded)
- `specs/018-chapter-N-claude-code-rework/SPEC-UPDATE-SUMMARY.md`
- `specs/018-chapter-N-claude-code-rework/PLAN-TASKS-UPDATE-REQUIREMENTS.md`
- `specs/018-chapter-N-claude-code-rework/UPDATE-COMPLETION-VALIDATION.md`
- `specs/018-chapter-N-claude-code-rework/CHAPTER-POSITIONING.md`
...
**Agent Status**: Baby/Preview (v0.1) - Successfully demonstrated in Chapter N Skills/Plugins/MCP session
