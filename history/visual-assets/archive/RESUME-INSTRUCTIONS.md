...
```
Image 3: book-source/docs/01-Introducing-AI-Driven-Development/02-ai-turning-point/02-user-interface-intent.md
...
Image 5: book-source/docs/01-Introducing-AI-Driven-Development/02-ai-turning-point/03-development-patterns.md
         (VISUAL ASSET 1 around line 183)
         Filename: team-comparison-vibe-vs-spec-timeline.png

Image 6: book-source/docs/01-Introducing-AI-Driven-Development/02-ai-turning-point/04-dora-perspective.md
         (VISUAL ASSET 1 around line 140)
         Filename: seven-dora-capabilities-ai-success.png

Image 7: book-source/docs/01-Introducing-AI-Driven-Development/02-ai-turning-point/05-ai-coding-agents.md
