...
**Chapter Directory**: `book-source/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/`
...
**Chapter Directory**: `book-source/docs/02-AI-Tool-Landscape/06-gemini-cli-installation-and-basics/`
...
**Chapter Directory**: `book-source/docs/02-AI-Tool-Landscape/07-bash-essentials/`
...
**Chapter Directory**: `book-source/docs/02-AI-Tool-Landscape/08-ai-native-ides/`
...
**Chapter Directory**: `book-source/docs/02-AI-Tool-Landscape/09-git-and-github/`
...
**Chapter Directory**: `book-source/docs/03-Markdown-Prompt-Context-Engineering/10-markdown-language-of-ai/`
...
**Chapter Directory**: `book-source/docs/03-Markdown-Prompt-Context-Engineering/11-prompt-engineering-for-aidd/`
...
**Chapter Directory**: `book-source/docs/03-Markdown-Prompt-Context-Engineering/12-context-engineering-for-ai-driven-development/`
...
**Chapter Directory**: `book-source/docs/04-Python-Fundamentals/13-python-uv-package-manager/`
...
**Chapter Directory**: `book-source/docs/04-Python-Fundamentals/14-introduction-to-python/`
...
**Chapter Directory**: `book-source/docs/04-Python-Fundamentals/15-data-types/`
