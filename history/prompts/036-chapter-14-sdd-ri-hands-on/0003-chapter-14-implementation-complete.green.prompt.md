...
labels: [implementation, chapter-14, sdd-ri, video-generation, educational-content]
links:
...
files:
  ...
  - book-source/docs/04-SDD-RI-Fundamentals/14-spec-kit-plus-hands-on/11-youtube-capstone.md
