...
4. **Who is the audience?** → User: "Mostly AI Super Orchestrator, then subagents (chapter-planner, lesson-writer, technical-reviewer), then human spec writers"
...
- 🔁 **Next prompts**:
  ...
  2. **Agent Updates**: Update chapter-planner, lesson-writer, technical-reviewer to enforce new forcing functions
...
- **Next experiment (smallest change to try)**:
  ...
  3. **Agent Prompt Updates**: Inject relevant constitutional sections into chapter-planner, lesson-writer, technical-reviewer system prompts
