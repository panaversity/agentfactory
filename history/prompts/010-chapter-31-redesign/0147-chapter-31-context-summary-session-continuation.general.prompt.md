...
user: mjs
command: none
labels: ["chapter-31", "context-summary", "session-continuation", "phr-documentation"]
links:
  ...
  pr: null
files:
  - history/prompts/010-chapter-31-redesign/0147-chapter-31-context-summary-session-continuation.general.prompt.md (created)
tests:
  - none (documentation)
---
