...
user: mjs
command: /sp.clarify
labels: ["chapter-31", "spec-clarify", "terminology-standardization", "calculator-capstone", "vertical-intelligence"]
links:
  ...
  pr: null
files:
  - specs/010-chapter-31-redesign/spec.md (updated - terminology, project, lessons)
tests:
...
- 📁 Files: Updated specs/010-chapter-31-redesign/spec.md (title, summary, lessons 1-8, success criteria, learning objectives, dependencies, acceptance criteria)
