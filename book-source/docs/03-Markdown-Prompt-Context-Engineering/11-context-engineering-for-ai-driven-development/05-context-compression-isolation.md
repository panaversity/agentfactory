...
> "We've been working together for 90 minutes building an authentication system. Help me create the perfect checkpoint: What information about our session would YOU need to resume effectively tomorrow? What decisions should I document that will keep our work consistent? How detailed should the checkpoint be—what's the right balance? What mistakes do developers commonly make when compressing context? Let's design a checkpoint template that works for both of us as partners."
